...
// ******************************************************************************************************
//  * Crie a Função de Login.Essa função vai conferir se o email e a senha são compatíveis com o que consta
//  *  no banco de dados. Em caso afirmativo, ela retorna como “true” (verdadeira). Adicione esta função ao 
...
// **************************************************************************************************** 
// Função Brute Force.Ataques de brute force ou força bruta acontecem quando hackers tentam milhares   
//  de diferentes senhas em uma só conta, se um usuário falhar em sua tentativa de login mais do que 5 
//  vezes, sua conta será bloqueada.//
// Uma das formas de prevenção inclui o uso do teste CAPTCHA, o qual bloqueia contas de usuários.
// O usuário ficara bloqueado pelos próximos 30 segundos.
...
// Isto é feito conferindo-se as variáveis de sessão "user_id" e "login_string".
// "login_string" possui as informações de endereço IP e navegador 
// você impede um ataque de hijack na sessão (sequestro de sessão, literalmente).
...
function esc_url($url){
    ...
    if ($url[0] !== '/') { 
// Estamos interessados somente em links relacionados provenientes de 
$_SERVER['PHP_SELF']        
return '';    
} else {        
    return $url;    
