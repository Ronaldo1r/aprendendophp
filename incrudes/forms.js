...
{ 
  ...
  { 
    // constantes SHA512 
    sha512_k  =  new  Array ( 
novo  int64 ( 0x428a2f98 ,  - 685199838 ),  novo  int64 ( 0x71374491 ,  0x23ef65cd ), 
...
novo  int64 ( 0x5Be0CD19 ,  0x177777741717 ;
...
{ 
   ...
   functios formhash(form,password){
    // crie um novo elemento de imput, o qual será o campo para senha com hash.
      ...
      conf.value == '') {        
        ...
        if(!re.test(form.username.value)) {         
          alert("Username must contain only letters, numbers and underscores. Please try again");
                  ...
                  // orientações específicas ao usuárioif (password.value.length < 6) {        
